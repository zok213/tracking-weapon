#!/usr/bin/env python3
"""
Train Near View MCF Model (YOLOv11x RGBT)
...
def train():
    ...
    print(f"Training NEAR VIEW model (close-range person detection)")
    ...
    phase1_last = runs_dir / "near_view_mcf_phase1/weights/last.pt"
    ...
    phase1_config = {
        ...
        'name': 'near_view_mcf_phase1',
        'exist_ok': True,
        'cache': 'ram',
        'workers': 12,
    }
    
    print("\n--- PHASE 1: Warm-up (Near View) ---")
    trainer1 = MCFTrainer(overrides=phase1_config, mcf_model=model.model)
    trainer1.train()
    
    # Phase 2: Full Fine-Tuning
    best_phase1 = runs_dir / "near_view_mcf_phase1/weights/best.pt"
    if not best_phase1.exists():
        best_phase1 = runs_dir / "near_view_mcf_phase1/weights/last.pt"
    ...
    phase2_config = {
        ...
        'freeze': None,
        'project': str(runs_dir),
        'name': 'near_view_mcf_phase2',
        'exist_ok': True,
        'cache': 'ram',
        'workers': 12,
    }
    
    print("\n--- PHASE 2: Full Fine-tuning (Near View) ---")
    trainer2 = MCFTrainer(overrides=phase2_config, mcf_model=model2.model)
    trainer2.train()
    
    print("\n✓ Near View MCF Training Complete!")
